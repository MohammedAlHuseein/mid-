...
const handlesignup=()=>{
  ...
  const userdata={name : fullname , type:usertype , city:city , email:email , password:pass}
    ...
    <div className="container">
      ...
      <div className="register-card">
        ...
        <div className="inputgroup">
          ...
          <input type="text" placeholder="Ex: Mohammad or Ali" dir="ltr" onChange={(e)=>setfullname(e.target.value)} />
        </div>
        <div className="inputgroup">
        ...
        <button onClick={handlesignup} className="submit-btn">
          ...
          <Typography sx={{mt:2, textAlign:"center"}}>
            ...
            <Link to="/"  style={{ textDecoration: 'none', color: '#e6ebf1', fontWeight: 'bold', marginLeft: '5px' }} >
            Login
            </Link>
